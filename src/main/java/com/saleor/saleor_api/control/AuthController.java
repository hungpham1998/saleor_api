...
//    public Resp registerEmail(@Valid @RequestBody Register register) {
//        Resp resp = new Resp();
//        Optional<TbUserSystem> optional = RepoUserSystem.findUserByEmail(register.getEmail());
//        TbUserSystem user = optional.get();
//        try {
//            user.setPassword(bCryptPasswordEncoder.encode(register.getPassword()));
//            RepoUserSystem.save(user);
//            resp.setSuccess(true);
//        }
//        catch (Exception ex){
//            resp.setSuccess(false);
